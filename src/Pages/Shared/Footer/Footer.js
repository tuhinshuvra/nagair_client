...
import FooterLogo from '../../../assets/logo/nag-air-logo.png';
import './Footer.css';
    ...
    return (
        <div className="container footer_bg">
            <footer className="pt-4">
                ...
                <div className=" ">
                    <p className=' text-center mb-0 copyright_text'> <small>Copyright @ 2023, All right reserved by Nag Air Ltd</small></p>
                </div>
            </footer >
        </div >
    );
