...
import './InternationalFlightsList.css'
...
const AddInternationalFlights = () => {
    ...
    return (
        <div className=' col-lg-6 col-md-8 col-10  mx-auto'>
            <h2 className='fw-bold text-center mt-4 mb-3'>Add International Flight</h2>
...
export default AddInternationalFlights;