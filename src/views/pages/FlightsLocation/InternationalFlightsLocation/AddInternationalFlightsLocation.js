...
import './InternationalFlightsLocationList.css'
...
const AddInternationalFlightsLocation = () => {
    ...
    const handleOnSubmit = (event) => {
        ...
        axios({
            url: `${process.env.REACT_APP_NAGAIR}/api/upload-international-flight`,
            method: "POST",
            ...
            .then((response) => {
                ...
                if (response.data.data) {
                    toast.success('Successfully added new International Flight')
                    navigate('/internationalFlightList')
                }
    ...
    return (
        <div className=' col-lg-6 col-md-8 col-10  mx-auto'>
            <h2 className="text-center  fw-bold  mt-5">Add International Flight's Location</h2>
            <div className=" d-flex  justify-content-end">
                <Link to="/internationalFlightList" className="fs-4  text-center text-decoration-none btn btn-outline-primary btn-sm   fw-bold  mt-0 mb-1  ">International Flight's Location List</Link>
            </div>
...
export default AddInternationalFlightsLocation;