...
import '../DomesticFlightsLocation/DomesticFlightsLocationList.css';
import useAuth from "../../../../hooks/useAuth";
import { getCookie } from "../../../../utilities/helper";
import ConfirmatinModal from "../../../components/Shared/ConfirmationModal/ConfirmationModal";

const InternationalFlightsLocationList = () => {
    ...
    return (
        <div>
            <h2 className="text-center  fw-bold  mt-5">International Flight Location List</h2>
            <div className=" d-flex  justify-content-end">
                <Link to="/internationalFlightAdd" className="fs-4  text-center text-decoration-none btn btn-outline-primary btn-sm   fw-bold  mt-0 mb-1  ">Add International Flight's Location</Link>
            </div>
...
export default InternationalFlightsLocationList;
